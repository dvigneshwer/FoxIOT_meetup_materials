...
# Turn on the LED4
def glow_4_on():    
	os.system("sshpass -p raspberry ssh -o StrictHostKeyChecking=no pi@10.100.16.26 python /home/pi/Desktop/glow_on.py &")
...
def glow_4_off():
	...
	os.system("sshpass -p raspberry ssh -o StrictHostKeyChecking=no pi@10.100.16.26 python /home/pi/Desktop/glow_off.py")
